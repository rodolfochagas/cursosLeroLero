$(document).ready(function(){
    ...
    $("#formulario-turmas").validate({
      rules: {
        ...
        turma_instrutores_id: {required: true},
        turma_cursos_id: {required: true},
        turma_data_inicio: {required: false},
	turma_data_final: {required: false},
        turma_carga_horaria: {required: false, minlength: 1, maxlength: 5},
      },
      messages: {
        turma_id: {
          required: " Este campo é obrigatório"},
        ...
        turma_carga_horaria: {
          minlength: " O campo carga horária deve possuir no mínimo 1 caracteres",
