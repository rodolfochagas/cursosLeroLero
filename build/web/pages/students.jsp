    ...
    <body>
        ...
        <% 
            ...
            while (r.next()) {
                ...
                out.println("<a href='../Student?approved=f&id=" + r.getInt("id") + "' class='btn btn-success'>Aprovar</a>");
                out.println("</div>");
                out.println("</div>");
            }
                ...
                <tbody>
                  <% 
                    ...
                    while (r2.next()) {
                        ...
                        out.println("<td><a href='updateStudent.jsp?studentId=" + r2.getInt("id") + "' class='btn btn-warning'>Alterar</a></td>");
                        out.println("</tr>");
                    }
                  %>
                </tbody>
