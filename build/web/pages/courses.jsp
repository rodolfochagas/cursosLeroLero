                ...
                <tbody>
                  <% 
                    ...
                    while (r.next()) {
                        ...
                        out.println("<td><a href='../Delete?id=" + r.getInt("id") + "&type=1' class='btn btn-danger'>Excluir</a></td>");
                        out.println("<td><a href='updateCourses.jsp?courseId=" + r.getInt("id") + "' class='btn btn-warning'>Alterar</a></td>");
                        out.println("</tr>");
                    }
                  %>
                </tbody>
                <% out.println("<td><a href='courses_table.jsp' class='btn btn-success'>Adicionar novos cursos</a></td>"); %>
              </table>
        </div>
    </body>
</html>
